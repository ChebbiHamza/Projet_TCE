...
def connect(host='http://google.com'):  # vérifier l'accés internet
    try:
        urllib.request.urlopen(host)  # Python 3.xx
        return True
    except:
        return False
...
def send_mail():
    ...
    # convertir le tableau csv en code html et l'ecrire sure le meme fichier chaque fois
...
def send_mail_TCE_on():
    ...
    html = """\
        <html>
            ...
            <body>
                <h1><mark style="color:green">  TCE ON ! </mark> </h1>
                <h3>
                <p>La maintenance preventif a été effectué avec succès, </p>
                <p>le nombre partiel est remis a zero: </p>
                </h3>
                {html_file_content}
            </body>
        </html>
    ...
    html = """\
        <html>
            ...
            <body>
                <h1><mark style="color:green">  TCE ON ! </mark> </h1>
                <h3>
                <p>La Table CE va bientôt atteindre le nombre maximum des cables partiels (60),</p>
                <p> un intervention préventive est nécessaire ! <p>
                <p>vérifier ci-dessous le nombre partiel et total atteint: </p>
                </h3>
                {html_file_content}
            </body>
...
# Créez une classe MIMEMultipart et configurez les champs From, To, Subject
    ...
    email_message['To'] = email_to
    email_message[
        'Subject'] = f'Avertissement d\'approche de la date du maintenance préventive - {date_str}'
